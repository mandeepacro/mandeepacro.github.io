...
function TestimonialCarousel({ carouselData }) {
  ...
  return (
    <OwlCarousel className='owl-theme md:mt-8' margin={36} stagePadding={16} items={1} dots={false} stageOuterClass={'owl-stage-outer md:pt-36 md:-mt-36'}
      responsive={{
        600: {
          stagePadding: 120
        },
    ...
    >

      {
        carouselData.map((item, index) => {
          return (
            <div className="item" key={`testmonial-carousel-${index}`}>
